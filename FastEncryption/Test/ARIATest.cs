...
namespace FastEncryption.Test
{
    internal class ARIATest
    {
        ...
        {
            Console.WriteLine();
            string folderPath = "../../../Test/test-vector/ARIA/ECB/";
        ...
        {
            Console.WriteLine();
            string folderPath = "../../../Test/test-vector/ARIA/CBC/";
            string[] filePaths = Directory.GetFiles(folderPath, "*.txt");
        ...
        {
            Console.WriteLine();
            string folderPath = "../../../Test/test-vector/ARIA/CFB/";
            string[] filePaths = Directory.GetFiles(folderPath, "*.txt");
        ...
        {
            Console.WriteLine();
            string folderPath = "../../../Test/test-vector/ARIA/OFB/";
            string[] filePaths = Directory.GetFiles(folderPath, "*.txt");
        ...
        {
            Console.WriteLine();
            string folderPath = "../../../Test/test-vector/ARIA/CTR/";
            string[] filePaths = Directory.GetFiles(folderPath, "*.txt");
        ...
        {
            Console.WriteLine();
            string folderPath = "../../../Test/test-vector/ARIA/GCM/";
            string[] filePaths = Directory.GetFiles(folderPath, "*.txt");
