...
{
    internal class TestECB
    {
        public static void Run()
        {
            Console.WriteLine("********************************************");
            Console.WriteLine("************** ECB Test Start **************");
            Console.WriteLine("********************************************\n\n");
            ...
            Console.WriteLine("********************************************");
            Console.WriteLine("*************** ECB Test End ***************");
            Console.WriteLine("********************************************\n\n");
        }

        private static void TestAES_ECB()
        {
            byte[] key = {
                0x12, 0x34, 0x56, 0x78,
                0x9A, 0xBC, 0xDE, 0xF0,
            ...
            TestMode test = new(ecb, key, plainText);
            test.Run();
        }

        private static void TestARIA_ECB()
        {
            byte[] key = {
                0x89, 0xAB, 0xCD, 0xEF,
                0x01, 0x23, 0x45, 0x67,
        ...
        private static void TestHIGHT_ECB()
        {
            byte[] key = {
                0xAA, 0xBB, 0xCC, 0xDD,
                0xEE, 0xFF, 0x00, 0x11,
        ...
        private static void TestSPECK_ECB()
        {
            byte[] key = {
                0x01, 0x23, 0x45, 0x67,
                0x89, 0xAB, 0xCD, 0xEF,
        ...
        private static void TestTWINE_ECB()
        {
            byte[] key = {
                0x0F, 0x1E, 0x2D, 0x3C,
                0x4B, 0x5A, 0x69, 0x78,
