...
namespace FastEncryption.Test
{
    internal class HIGHTTest
    {
        ...
        {
            Console.WriteLine();
            string folderPath = "../../../Test/test-vector/HIGHT/ECB/";
        ...
        {
            Console.WriteLine();
            string folderPath = "../../../Test/test-vector/HIGHT/CBC/";
            string[] filePaths = Directory.GetFiles(folderPath, "*.txt");
        ...
        {
            Console.WriteLine();
            string folderPath = "../../../Test/test-vector/HIGHT/CFB/";
            string[] filePaths = Directory.GetFiles(folderPath, "*.txt");
        ...
        {
            Console.WriteLine();
            string folderPath = "../../../Test/test-vector/HIGHT/OFB/";
            string[] filePaths = Directory.GetFiles(folderPath, "*.txt");
        ...
        {
            Console.WriteLine();
            string folderPath = "../../../Test/test-vector/HIGHT/CTR/";
            string[] filePaths = Directory.GetFiles(folderPath, "*.txt");
