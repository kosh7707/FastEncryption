...
namespace FastEncryption.Test
{
    internal class SPECKTest
    {
        ...
        {
            Console.WriteLine();
            string folderPath = "../../../Test/test-vector/SPECK/ECB/";
        ...
        {
            Console.WriteLine();
            string folderPath = "../../../Test/test-vector/SPECK/CBC/";
            string[] filePaths = Directory.GetFiles(folderPath, "*.txt");
        ...
        {
            Console.WriteLine();
            string folderPath = "../../../Test/test-vector/SPECK/CTR/";
            string[] filePaths = Directory.GetFiles(folderPath, "*.txt");
