using Encryption_Symmetric.EncryptionAlgorithm;
using System;
...
namespace Encryption_Symmetric.OperationMode
{
    public class CFB(IEncryptionAlgorithm encryptionAlgorithm) : OperationMode(encryptionAlgorithm)
    {
        public override byte[] Encrypt(byte[] plainText)
        {
            ...
            for (int i = 0; i < plainText.Length; i += blockSize)
            {
                ...
                Array.Copy(cipherText, i + blockSize, feedback, 0, bytesToProcess);
            }
        ...
        public override byte[] Decrypt(byte[] cipherText)
        {
            ...
            for (int i = blockSize; i < cipherText.Length; i += blockSize)
            {
                ...
                Array.Copy(cipherText, i, feedback, 0, bytesToProcess);   
            }
