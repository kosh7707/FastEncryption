...
namespace Encryption_Symmetric.EncryptionAlgorithm
{
    public class SPECK : EncryptionAlgorithm
    {
        ...
        public override byte[] Encrypt(byte[] plainText)
        {
            ...
            Buffer.BlockCopy(BitConverter.GetBytes(Ct[0]), 0, cipherText, 0, 8);
            Buffer.BlockCopy(BitConverter.GetBytes(Ct[1]), 0, cipherText, 8, 8);
        ...
        public override byte[] Decrypt(byte[] cipherText)
        {
            ...
            Buffer.BlockCopy(BitConverter.GetBytes(Pt[0]), 0, plainText, 0, 8);
            Buffer.BlockCopy(BitConverter.GetBytes(Pt[1]), 0, plainText, 8, 8);
