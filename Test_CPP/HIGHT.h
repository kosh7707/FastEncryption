#ifndef CPRACTICE_HIGHT_H
#define CPRACTICE_HIGHT_H
...
public:
    ...
    void HIGHT_Decrypt(uint8_t* RoundKey, uint8_t* Data) {
        uint32_t XX[8];
    ...
    void HIGHT_KeySched(uint8_t* UserKey, uint8_t* RoundKey) {
        for (int i=0; i<4; i++) {
...
private:
    constexpr static uint8_t Delta[128] = {
    ...
    constexpr static uint8_t HIGHT_F0[256] = {
    ...
    constexpr static uint8_t HIGHT_F1[256] = {
